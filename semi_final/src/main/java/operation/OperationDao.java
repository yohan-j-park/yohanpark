...
public class OperationDao{
	...
	public List<OperationVo> select(Page pageVo){
		...
		try {
			...
			ps.setString(3, "%" + pageVo.getFindMachine_no() + "%");
			ps.setString(4, "%" + pageVo.getFindManager() + "%");
			ps.setString(5, "%" + pageVo.getFindPrname() + "%");
		...
		try {
			...
			rs = ps.executeQuery();
			 ...
			 if(rs.next()) { 
					...
					/*
					 * switch(rs.getString("pr_name")) { case "엑스봇로봇두뇌": pr_cost = "250000";
					 * real_price = "1000000"; vat = "100000"; break; case "엑스봇로봇팔": pr_cost =
					 * "250000"; real_price = "5000000"; vat = "500000"; supply_price = "5500000";
					 * break; case "엑스봇로봇다리": pr_cost = "350000"; real_price = "7000000"; vat =
					 * "700000"; supply_price = "7700000"; break; case "엑스봇로봇머리": pr_cost =
					 * "250000"; real_price = "5000000"; vat = "500000"; supply_price = "5500000";
					 * break; case "엑스봇로봇몸통": pr_cost = "250000"; real_price = "5000000"; vat =
					 * "500000"; supply_price = "5500000"; break; case "엑스봇로봇신경": pr_cost =
					 * "600000"; real_price = "1000000"; vat = "100000"; supply_price = "1100000";
					 * break;
					 * 
					 * }
					 */
